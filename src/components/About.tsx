    ...
    <div className="p-4">
      ...
      <section className="mb-4">
        ...
        <p>
          ...
          Blisko 20 tysięcy szczytów górskich na terenie Polski i w pobliżu granic jest dostępnych
          na mapie. Użytkownicy mogą odznaczać zdobyte szczyty. Na niektóre szczyty nie ma
          bezpośredniego podejścia (drogą, szlakiem), więc zachowaj roztropność. Zdobywając szczyty
          pasek postępu będzie przybierać na wartości co da orientację ile już się zwiedziło.
        </p>
      </section>
